...
ALTER TABLE `fact_detalle` CHANGE `tipAfeIGV` `tipAfeIGV` FLOAT NULL DEFAULT '10.5'; 
ALTER TABLE `fact_detalle` CHANGE `porIgvItem` `porIgvItem` FLOAT NULL DEFAULT '18';
