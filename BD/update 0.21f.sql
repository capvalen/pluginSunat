INSERT INTO `gravados` (`idGravado`, `gravDescripcion`) VALUES (NULL, 'Operación Gratuita'), (NULL, 'Bonificación');
ALTER TABLE `clientes` ADD `esProveedor` INT NOT NULL DEFAULT '0' AFTER `cliActivo`;



ALTER TABLE `fact_cabecera` ADD `serieBaja` VARCHAR(250) NOT NULL AFTER `fechaBaja`;
ALTER TABLE `fact_detalle` ADD `idProducto` INT NOT NULL DEFAULT '0' AFTER `idGravado`;
